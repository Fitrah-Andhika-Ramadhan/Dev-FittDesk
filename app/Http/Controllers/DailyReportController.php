...
class DailyReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $report->load('user'); // Load user for the notification

        \App\Services\NotificationService::sendDailyReportCreated($report);
    ...
    public function update(Request $request, DailyReport $dailyReport)
    {
        ...
        \App\Services\NotificationService::sendDailyReportUpdated($dailyReport);
