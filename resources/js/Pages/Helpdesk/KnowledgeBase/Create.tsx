...
export default function Create({ auth }: PageProps) {
    ...
    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Tulis Artikel Baru</h2>}>
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <form onSubmit={submit}>
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700">Konten (Mendukung baris baru)</label>
                                    <textarea 
                                        value={data.content} 
